...
const checkCollisions = (cannonBalls: Array<IFlyingObject>, flyingDiscs: Array<IFlyingObject>) => {
    const objectsDestroyed: any = [];

    flyingDiscs.forEach((flyingDisc: IFlyingObject) => {
        ...
        cannonBalls.forEach((cannonBall: IFlyingObject) => {
            const rectB = {
